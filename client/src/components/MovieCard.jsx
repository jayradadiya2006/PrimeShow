...
export const MovieCard = ({ movie, onSelect, onBookNow }) => {
  ...
  return (
    <div 
      ...
      className="group relative rounded-2xl sm:rounded-3xl overflow-hidden glass-panel border border-[#C1BAA1] hover:border-[#A59D84] card-hover-3d cursor-pointer shadow-lg hover:shadow-2xl flex flex-col justify-between transition-all duration-300 active:scale-[0.98]"
    >
      ...
      <div className="relative aspect-[2/3] w-full overflow-hidden bg-[#D7D3BF] shrink-0">
        ...
        <div className="absolute top-2.5 left-2.5 right-2.5 flex items-center justify-between z-10">
          <span className="px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-full bg-[#D7D3BF]/90 backdrop-blur-md border border-[#C1BAA1] text-[9px] sm:text-[10px] font-extrabold text-amber-600 uppercase tracking-wider">
