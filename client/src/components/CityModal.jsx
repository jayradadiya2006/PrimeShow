...
import { X, MapPin, Check, Search, Sparkles, Map, LayoutGrid } from 'lucide-react';
import { useAuth } from '../context/AuthContext';
import { GUJARAT_CITIES, POPULAR_GUJARAT_CITIES } from '../constants/cities';
import { GujaratMapSelector } from './GujaratMapSelector';
...
export const CityModal = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/85 backdrop-blur-xl animate-fade-in">
      <div className="relative w-full max-w-4xl glass-modal rounded-3xl p-5 sm:p-7 border border-white/15 shadow-2xl text-white max-h-[92vh] flex flex-col overflow-hidden">
        ...
        {/* Header Section */}
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4 shrink-0 pr-10">
          <div className="flex items-center gap-3">
            <div className="p-3 rounded-2xl bg-amber-500/20 text-amber-400 border border-amber-400/30">
              <MapPin className="w-6 h-6" />
            </div>
            <div>
              <h3 className="text-xl sm:text-2xl font-bold font-sans text-white flex items-center gap-2">
                Select Gujarat City
        ...
        {/* View Mode 1: Interactive SVG Gujarat Map */}
        {viewMode === 'map' ? (
          ...
          /* View Mode 2: Search Bar + Grid List */
          <div className="flex flex-col flex-1 overflow-hidden">
            ...
            <div className="relative mb-4 shrink-0">
              ...
              <input
                type="text"
                placeholder="Search Gujarat city (e.g. Surat, Ahmedabad, Jamnagar, Bharuch, Palanpur...)"
                value={searchTerm}
              ...
              <div>
                <div className="flex items-center justify-between mb-3">
                  <span className="text-xs font-bold uppercase tracking-wider text-white/70">
                    {searchTerm ? `Search Results (${filteredCities.length})` : 'All 18 Gujarat Supported Cities'}
                  </span>
                </div>
